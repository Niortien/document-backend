...
export class UserController {
  ...
  @ApiOperation({
    ...
    description: 'Création d\'un compte (étudiant, professeur ou admin) par un administrateur, avec un mot de passe par défaut. L\'utilisateur pourra ensuite le changer via PATCH /auth/change-password.',
  })
